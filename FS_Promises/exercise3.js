...
//First promisse chain

myPromise

    .then((result) => {
        console.log("First chain Resolved", result);
    ...
    .catch((error) => {
        console.log("Erorr found at first chain", error);
    });
...
myPromise.then((result) => {
    console.log("Second chain resolved", result);
    ...
    .catch((error) => {
        console.log("Error found at second chain", error);
    })
